...
import { getActiveRestaurantCityWise, inactiveRestaurant } from "../../../features/user/restaurantSlice";
...
function GetAllActiveRestaurantCityWise() {
  ...
  useEffect(() => {
    dispatch(getActiveRestaurantCityWise({ city: selectedCity, page: 1 }));
      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50 p-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-[95%] md:w-200 max-h-[90vh] overflow-y-auto p-6 relative">
          ...
          <div className=" flex items-center justify-end">
           <button onClick={() => handelInactive(selectedRestaurant._id)} className=" bg-red-400 px-2 py-1 rounded-xl hover:bg-red-500 hover:text-white duration-300 cursor-pointer">Inactive</button>
          </div>
